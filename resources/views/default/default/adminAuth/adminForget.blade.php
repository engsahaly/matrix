		...
		<div class="wrapper row justify-content-center align-items-center">
			...
			<div class="card mb-0 col-sm-12 col-md-4 p-0">
				<div class="card-header text-center text-uppercase">
					<h3 class="text-primary">Admin Forget Password</h3>
				</div>
				<div class="card-body">
					...
					@endif
					<x-jet-validation-errors class="mb-4 alert alert-danger text-danger" />

					<form action="{{ route('admin.password.email') }}" method="post">
						@csrf
						<div class="form-group">
							<label for="email" class="form-label">Email address</label>
							<input type="email" class="form-control" id="email" name="email" placeholder="email@example.com" :value="old('email')" required autofocus>
						</div>				
