...
<body data-background-color="dark2">
	...
	<div class="wrapper">
		...
		@include("default.partials.doctorHeader")
		
		<!-- include doctor sidebar -->
		@include("default.partials.doctorSide")
		...
		<div class="main-panel">			
			...
			@include("default.partials.doctorFooter") 
		</div>
...
@else
	<script>window.location.href= "{{ url('/doctor/login') }}";</script>
@endif
